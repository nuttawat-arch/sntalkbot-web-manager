# นำ SNTalkBot Web Manager 1.1.11 ขึ้น GitHub
...
git branch -M main
git add -A
git commit -m "Initial SNTalkBot Web Manager 1.1.11"
...
Web Manager 1.1.11 ใช้ SQLite ไม่ได้ใช้ `auth.json` เป็นฐานบัญชีอีกแล้ว ข้อมูล/secret จริงอยู่ภายนอก source tree เช่น:
